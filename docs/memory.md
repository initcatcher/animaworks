...
> 作成日: 2026-02-14
> 関連: [vision.md](vision.md), [spec.md](spec.md), [design/implemented/priming-layer-design.md](design/implemented/priming-layer-design.md)
...
- [design/implemented/priming-layer-design.md](design/implemented/priming-layer-design.md) — プライミングレイヤー実装計画書（RAG設計、固定化アーキテクチャ含む）
